...
**Note3:** The result of CAFE5 shows that it is a problem. [CAFE_fig](https://github.com/LKremer/CAFE_fig) is no longer suitable for CAFE5, but only for older versions of CAFE. 
